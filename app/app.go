...
import (
	...
	appparams "github.com/enflow.io/enf1/app/params"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/enf1d")
	}
	...
	maccPerms = map[string][]string{
		...
		enf1types.ModuleName:           {authtypes.Minter, authtypes.Burner, authtypes.Staking},
	}

	// module accounts that are allowed to receive tokens
	allowedReceivingModAcc = map[string]bool{
		distrtypes.ModuleName: true,
		enf1types.ModuleName:  true,
	}
)
...
func New(
	...
	app.enf1Keeper = *enf1keeper.NewKeeper(
		appCodec, keys[enf1types.StoreKey], keys[enf1types.MemStoreKey], app.BankKeeper, app.StakingKeeper,
		app.AccountKeeper,
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		enf1.NewAppModule(appCodec, app.enf1Keeper),
